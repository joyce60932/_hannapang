 ...
 *   出國：82 萬 ÷ 8 萬（歐洲旅行/次）≈ 10 次
 *   糖顆數：60g ÷ 5g ≈ 12 顆方糖/杯 × 3,650 杯 = 43,800 顆
 */
      ...
      return {
        ...
        cards: [
          ...
          { id: 'h2', type: 'stat', img: A.sugar || '',
            kicker: '10 年喝進的糖 =', big: '43,800 顆方糖',
            label: '一杯 ≈ 12 顆方糖 × 3,650 杯（≈ 219 公斤）',
            note: 'WHO 建議每天 <25g，一杯就超標 2 倍' },
          // 3 熱量（體重計）
          { id: 'h3', type: 'stat', img: A.scale || '',
